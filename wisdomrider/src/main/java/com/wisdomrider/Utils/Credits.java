...
public class Credits extends android.support.v7.widget.AppCompatTextView implements Runnable {

    private static final float DEFAULT_SPEED = 19.0f;
    ...
    public Credits(Context context, AttributeSet attributes) {
